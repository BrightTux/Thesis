...
However, the recall metrics showed a different side of the story when the average recall rate fell from 39.67\% to 18.01\% for TQ1 and 
68.15\% to 51.85\% for TQ2. This drastic drop in for recall metrics shows direct co-relation to the requirement to fulfill Equation \ref{eq:CVscore} for each retrieved shots. As a whole, the $F_1$ score metric was used to evaluate the performance of the proposed method as it provides a balance between both of these desirable metrics. Based on the results, queries with the lowest CV and lower number of inputs tend to perform better than the other parameter settings. The proposed method was able to achieve an $F_1$ score of 74.32\% and 68.08\% for both TQ1 and TQ2. 
