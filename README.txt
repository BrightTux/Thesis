mmuthesis, a LaTeX class for typesetting a Multimedia University (MMU)
postgraduate research thesis.
    Copyright (C) 2010--2016  Lim Lian Tze

    You are recommended to use thesis.tex as a starting template.

    Files:
    mmuthesis.cls         LaTeX class file
    mmuthesis-manual.pdf  A quick user guide
    thesis.tex            Example 'main' thesis .tex file
    thesis.pdf            Example PDF file of a MMU thesis, can be
                          generated from thesis.tex and friends
    sample-abstract.tex   Sample thesis abstract
    sample-preface.tex    Sample thesis preface
    ...
    llt.bib               Sample BibTeX bibliography database file
    README                This file
