...
\newcommand{\versionOneRet}{LSH-Inspired Retrieval Engine }
\newcommand{\versionTwoRet}{Chamfer Distance based Retrieval Engine  }
...
\title{Extraction and Retrieval of Object Semantics for Long-Term Car Park Surveillance Videos }
\submissionyear{2018}
