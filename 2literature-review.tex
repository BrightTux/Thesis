...
\begin{figure}[hbt!]
 ...
 Rate for Different Wavelengths of Light. Figure reproduced from {~\citeA{college_2013}.}%'Blue' Cones, Approximately 420-440 nm, are Short Wavelengths Light; 'Green' Cones, Approximately 534-545 nm, are Medium Wavelengths Light; and, 'Red' Cones, Approximately 564-580 nm, are Long Wavelength Lights. 
 }
...
% \begin{figure}[hbt!]
%   \centering
%   \includegraphics[width=.6\textwidth]{image/lit/yusnita.png}
%   \caption[Left: Images from Cameras. Right: Resulting Image after Segmentation, Enhancement and Object Tracing.] {Left: Images from Cameras. Right: Resulting Image after Segmentation, Enhancement and Object Tracing. Reproduced from~\cite{yusnita2012intelligent}.}
% \label{fig:yusnita}
% \end{figure}
...
% hampapur2004s3 # done
% shi2017study
% marmol2016quickspot # done
% ling2017identifying # done
% yusnita2012intelligent #done
% yang2012smart # not doing
% chen2010vision # done

\begin{table}[tb!]
\centering
\caption{Summary of Related Works in Car Park Setting}
\label{table:litsum}
\vspace{0.5em}
\resizebox{\textwidth}{!}{
\begin{tabular}{|l|c|c|c|c|c|c|c|}
\hline
                                                & \textbf{\begin{tabular}[c]{@{}c@{}}Vehicle \\ Detection\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Motion \\ Tracking\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Parking \\ Lot \\ Detection\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Parking \\ Lot \\ Availability\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Colour \\ Extraction\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Event \\ Retrieval\end{tabular}} & \textbf{Duration} \\ \hline
\citeA{hampapur2004s3}         & Undisclosed                                                                    & Undisclosed                                                                  & -                                                                            & -                                                                               & Vehicle                                                               & Text Based                                                          & 24 Hours          \\ \hline
\citeA{chen2010vision}         & \begin{tabular}[c]{@{}c@{}}Edge \\ detection\end{tabular}             & -                                                                   & \begin{tabular}[c]{@{}c@{}}Manually \\ marked\end{tabular}                   & \begin{tabular}[c]{@{}c@{}}Edge \\ Detection\end{tabular}                       & Floor                                                                 & -                                                                   & -                 \\ \hline
\citeA{yusnita2012intelligent} & -                                                                     & -                                                                   & \begin{tabular}[c]{@{}c@{}}Manually \\ marked\end{tabular}                   & Handcrafted                                                                     & -                                                                     & -                                                                   & -                 \\ \hline
\citeA{marmol2016quickspot}    & \begin{tabular}[c]{@{}c@{}}FAST, \\ SURF\end{tabular}                 & -                                                                   & \begin{tabular}[c]{@{}c@{}}Manually \\ marked\end{tabular}                   & KNN                                                                             & -                                                                     & -                                                                   & 5 Hours           \\ \hline
\citeA{ling2017identifying}    & Haar Features                                                         & -                                                                   & \begin{tabular}[c]{@{}c@{}}Topology \\ Learning\end{tabular}                 & Automated                                                                       & -                                                                     & -                                                                   & -                 \\ \hline
\textbf{Proposed Method}                        & BGS                                                                   & Centroid                                                            & -                                                                            & -                                                                               & Vehicle                                                               & \begin{tabular}[c]{@{}c@{}}\textbf{Sketch,} \\ \textbf{Text based}\end{tabular}       & \textbf{1 Month}           \\ \hline
\end{tabular}}
\end{table}
...
Owning to that fact that colour perception varies from each user's perspective, compounded by the fact that most monitor screens are not colour calibrated professionally provided an opportunity for~\citeA{munroe2010color} to perform an internet crowd-sourcing survey on colour terms and their corresponding numeral representation according to how colours are displayed on typical monitors.
