...
An interesting excerpt by \citeA{albers2006interaction} states that ``In order to use color effectively it is necessary to recognize that color deceives continually. To this end, the beginning is not a study of color systems.
First, it should be learned that one and the same color evokes innumerable readings. Instead of mechanically applying or merely implying laws and rules of color harmony, distinct color effects are produced-through recognition of the interaction of color-by making, for instance, two very different colors look alike, or nearly alike''. Hence, the human visual system is first explored to understand how to use colors effectively.
