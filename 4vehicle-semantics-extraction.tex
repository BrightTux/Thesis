...
However, users who are not familiar with the terminology used in by specific systems may find keyword-based statements non-intuitive and difficult to decipher.
...
The $15-8-8$ configuration is inspired by the works of \cite{kim2008deciding, castanon2016retrieval}. \citeA{kim2008deciding}'s experiments show that the $8-4-4$ configuration showed the best results.
